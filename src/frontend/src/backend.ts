...
import type { CaseStatus as _CaseStatus, ForensicsCase as _ForensicsCase, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createCase(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createCase(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCases(): Promise<Array<ForensicsCase>> {
        if (this.processError) {
            try {
    ...
    async getCaseById(arg0: string): Promise<ForensicsCase> {
        if (this.processError) {
            try {
                const result = await this.actor.getCaseById(arg0);
                return from_candid_ForensicsCase_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateCase(arg0: string, arg1: CaseStatus, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCase(arg0, to_candid_CaseStatus_n18(this._uploadFile, this._downloadFile, arg1), arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ForensicsCase_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ForensicsCase): ForensicsCase {
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "tampered" in value ? CaseStatus.tampered : "clean" in value ? CaseStatus.clean : "suspicious" in value ? CaseStatus.suspicious : value;
}
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ForensicsCase>): Array<ForensicsCase> {
    return value.map((x)=>from_candid_ForensicsCase_n11(_uploadFile, _downloadFile, x));
}
function to_candid_CaseStatus_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CaseStatus): _CaseStatus {
...
function to_candid_variant_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CaseStatus): {
    tampered: null;
} | {
    clean: null;
} | {
    ...
    return value == CaseStatus.tampered ? {
        tampered: null
    } : value == CaseStatus.clean ? {
        clean: null
    } : value == CaseStatus.suspicious ? {
        suspicious: null
    } : value;
}
